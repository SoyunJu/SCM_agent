...
DEFAULT_SETTINGS: dict[str, tuple[str, str]] = {
    ...
    "AUTO_ORDER_APPROVAL":            ("false",   "발주 자동 승인 여부 (true=즉시승인 | false=승인대기)"),
    "ORDER_AUTO_APPROVE_LIMIT":       ("100000",  "자동 승인 한도 금액 (원, 이하 금액은 즉시 승인)"),
    "ORDER_MANAGER_APPROVAL_LIMIT":   ("1000000", "SUPERADMIN 승인 한도 금액 (원, 이상 금액은 최고관리자 승인)"),
    "DEFAULT_LEAD_TIME_DAYS":         ("14",      "기본 리드타임 (일, 상품별 설정 없을 때 적용)"),
